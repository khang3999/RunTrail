...
sudo docker run -d --restart=always --name runtrailbe -e DB_HOST=54.255.118.114 -e DB_PORT:3306 -e DB_USER=root -e DB_PASS=runtrail123@ -e APP_PORT=8080  -p 8080:8080 10102004tan/runtrailbe
