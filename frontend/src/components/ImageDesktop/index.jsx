...
export default function ImageDesktop({ product = null, isLoading = false }) {
  const perPage = 5;
  ...
  return (
    <>
      ...
      {/* Image section */}
      <div className={`w-full h-full flex flex-col  border-1 justify-center items-center fix-image-magnifier`}>
        {/* Hover image */}
