...
function ProductProvider({ children }) {
   ...
   const [selectedBrands, setSelectedBrands] = useState(params.brandIds && params.brandIds.split(",").length > 0 ? params.brandIds.split(",") : []);
   const [selectedSizes, setSelectedSizes] = useState(params.key === "Size" && params.value.split(",").length > 0 ? params.value.split(",") : []);
   const [contentOrderBy, setContentOrderBy] = useState(params.contentOrderBy || "desc");
