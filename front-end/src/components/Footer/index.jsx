    ...
    <div>
      <div className="grid lg:grid-cols-4 w-full lg:px-[135px] lg:py-[40px] px-[25px] py-[10px] bg-[#858688] text-white">
        <div className="lg:pr-[30px] pt-[30px]">
          ...
          <p className="text-justify my-[15px] tracking-wide	">
            SuperSports chuyên giày dép, quần áo và phụ kiện chạy bộ/chạy địa
            hình chính hãng đến từ các thương hiệu hàng đầu thế giới. Chúng tôi
            luôn có sẵn những dòng sản phẩm mới nhất, tối ưu và hiệu suất cao
            dành cho runners. Đội ngũ nhân viên trẻ trung, nhiệt huyết, là những
            chân chạy đã được tích luỹ nhiều kinh nghiệm tập luyện và thi đấu sẽ
            mang đến tinh thần phục vụ chuyên nghiệp và chuyên sâu nhất cho
            khách hàng
          </p>
        </div>
        <div className=" lg:pr-[30px] pt-[30px]">
          <div className="footer-block information-block">
            ...
            <p className="text-left text-white my-[7px] underline">
              <strong>HÀ NỘI</strong>
            </p>

            <p className="text-left text-white my-[7px]">
            ...
            <p className="text-left text-white my-[7px]">
              - B11, 423 Minh Khai, Hai Bà Trưng
            </p>
            <p className="text-left text-white my-[7px]">
        ...
        <div className="lg:pr-[30px] pt-[30px]">
          <div className="footer-block contact-block">
            ...
            <p className="text-left my-[7px]">
              <a href="#" className="hover:text-cyan-500">
                <span className="text-white hover:text-sky-800">
        ...
        <div className=" pb-[30px]">
          ...
          <a href="tel:+ 84 384 969 973">
            <p className="text-left text-white my-[7px] hover:text-red-200">
              Hotline/Zalo Tư vấn: 0384 969 973
            </p>
          </a>
          <a href="mailto: dongochieu333@gmail.com">
            <p className="text-left text-white my-[7px] hover:text-amber-200">
              Email: dongochieu333@gmail.com
            </p>
          </a>
