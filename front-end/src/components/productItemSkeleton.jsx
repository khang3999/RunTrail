            ...
            <div className="group product-item rounded border-2">
                ...
                <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden bg-gray-200">
                    <Link href="/detail" className="title">
                        <div className="image-wrap relative w-full h-[250px] bg-gray-300">
                ...
                {/* Information */}
                <div className="group px-[15px] my-5">
                    {/* Body */}
                    <div className="item-body h-[160px]">
                        <div className='bg-gray-200 w-10 h-5 mb-1'></div>
                        <div className='bg-gray-200 w-full h-[50px] pt-3'></div>
                        <div className='bg-gray-200 w-full h-[30px] mt-3'></div>
