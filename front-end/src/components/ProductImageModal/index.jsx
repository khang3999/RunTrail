...
function ProductImageModal({
   ...
   if (loading) {
      return (
         <div
            className={`rounded-sm p-3 select-none transition-all duration-300 overflow-hidden flex items-center justify-center ease-in-out fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] bg-white z-[10000] ${visible ? ' opacity-100' : ' opacity-0'
               } `}
            style={{
               width: width,
               height: height,
