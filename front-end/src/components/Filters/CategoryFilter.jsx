...
const CategoryFilter = () => {
   ...
   const { categoryId, setCategoryId, setSelectedSizes, setSelectedBrands } = useProductProvider();
      ...
      return categories.map((category) => {
         ...
         return (
            <div key={category.id} className="mb-2">
               <div
                  className={`flex justify-between items-center cursor-pointer py-2 hover:text-purple-400 ${openParentCategory[category.id] ? "text-purple-600" : ""
